...
public class VentanaAdmin extends JFrame {
		...
		btnElimiarArticulo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					BD.closeBD(con);
					JOptionPane.showMessageDialog(null, "Art�culo eliminado de la BBDD ","DONE", JOptionPane.INFORMATION_MESSAGE);
	...
	/**
	 * Metodo que permite a�adir los aritculos a la lista
	 */
